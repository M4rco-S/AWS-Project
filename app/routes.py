...
import json
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://admin:12345678@aws-dev-project-database.aws-dev-project-database.cu2axqbcvtdk.us-east-1.rds.amazonaws.com'
